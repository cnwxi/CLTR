...
#!/usr/bin/env bash
export ASCEND_RT_VISIBLE_DEVICES=0,7 #4,5,6,7

export OMP_NUM_THREADS=1 
export MKL_NUM_THREADS=1

TORCHRUN_ARGS="--nproc_per_node=2 --nnodes=1 --master_addr=localhost --master_port=12323"

torchrun $TORCHRUN_ARGS train_distributed.py --gpu_id '0,7' \
--gray_aug --gray_p 0.1 --scale_aug --scale_type 1 --scale_p 0.3 --epochs 1500 --lr_step 900 --lr 1e-6 \
